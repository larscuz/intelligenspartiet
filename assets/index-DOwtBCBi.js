...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ka,depthTest:!1,depthWrite:!1})}function hT(r,t,i){const s=new Float32Array($r),l=new K(0,1,0);return new Ia({name:"SphericalGaussianBlur",defines:{n:$r,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:wh(),fragmentShader:`
		...
		`,blending:Ka,depthTest:!1,depthWrite:!1})}function lx(){return new Ia({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wh(),fragmentShader:`
		...
		`,blending:Ka,depthTest:!1,depthWrite:!1})}function cx(){return new Ia({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wh(),fragmentShader:`
	...
	`}class n0 extends La{constructor(t=1,i={}){super(t,t,i),this.isWebGLCubeRenderTarget=!0;const s={width:t,height:t,depth:1},l=[s,s,s,s,s,s];this.texture=new Qm(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new _r(5,5,5),c=new Ia({name:"CubemapFromEquirect",uniforms:pl(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:_i,blending:Ka});c.uniforms.tEquirect.value=i;const h=new We(l,c),d=i.minFilter;return i.minFilter===ws&&(i.minFilter=ni),new NS(1,10,this).update(t,h),i.minFilter=d,h.geometry.dispose(),h.material.dispose(),this}clear(t,i=!0,s=!0,l=!0){const c=t.getRenderTarget();for(let h=0;h<6;h++)t.setRenderTarget(this,h),t.clear(i,s,l);t.setRenderTarget(c)}}function dT(r){let t=new WeakMap,i=new WeakMap,s=null;function l(g,y=!1){return g==null?null:y?h(g):c(g)}function c(g){if(g&&g.isTexture){const y=g.mapping;if(y===pf||y===mf)if(t.has(g)){const E=t.get(g).texture;return d(E,g.mapping)}else{const E=g.image;if(E&&E.height>0){const w=new n0(E.height);return w.fromEquirectangularTexture(r,g),t.set(g,w),g.addEventListener("dispose",p),d(w.texture,g.mapping)}else return null}}return g}function h(g){if(g&&g.isTexture){const y=g.mapping,E=y===pf||y===mf,w=y===mr||y===no;if(E||w){let M=i.get(g);const S=M!==void 0?M.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==S)return s===null&&(s=new ch(r)),M=E?s.fromEquirectangular(g,M):s.fromCubemap(g,M),M.texture.pmremVersion=g.pmremVersion,i.set(g,M),M.texture;if(M!==void 0)return M.texture;{const C=g.image;return E&&C&&C.height>0||w&&C&&m(C)?(s===null&&(s=new ch(r)),M=E?s.fromEquirectangular(g):s.fromCubemap(g),M.texture.pmremVersion=g.pmremVersion,i.set(g,M),g.addEventListener("dispose",_),M.texture):null}}}return g}function d(g,y){return y===pf?g.mapping=mr:y===mf&&(g.mapping=no),g}function m(g){let y=0;const E=6;for(let w=0;w<E;w++)g[w]!==void 0&&y++;return y===E}function p(g){const y=g.target;y.removeEventListener("dispose",p);const E=t.get(y);E!==void 0&&(t.delete(y),E.dispose())}function _(g){const y=g.target;y.removeEventListener("dispose",_);const E=i.get(y);E!==void 0&&(i.delete(y),E.dispose())}function v(){t=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:v}}function pT(r){const t={};function i(s){if(t[s]!==void 0)return t[s];const l=r.getExtension(s);return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&wc("WebGLRenderer: "+s+" extension not supported."),l}}}function mT(r,t,i,s){const l={},c=new WeakMap;function h(v){const g=v.target;g.index!==null&&t.remove(g.index);for(const E in g.attributes)t.remove(g.attributes[E]);g.removeEventListener("dispose",h),delete l[g.id];const y=c.get(g);y&&(t.remove(y),c.delete(g)),s.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function d(v,g){return l[g.id]===!0||(g.addEventListener("dispose",h),l[g.id]=!0,i.memory.geometries++),g}function m(v){const g=v.attributes;for(const y in g)t.update(g[y],r.ARRAY_BUFFER)}function p(v){const g=[],y=v.index,E=v.attributes.position;let w=0;if(E===void 0)return;if(y!==null){const C=y.array;w=y.version;for(let U=0,D=C.length;U<D;U+=3){const B=C[U+0],H=C[U+1],G=C[U+2];g.push(B,H,H,G,G,B)}}else{const C=E.array;w=E.version;for(let U=0,D=C.length/3-1;U<D;U+=3){const B=U+0,H=U+1,G=U+2;g.push(B,H,H,G,G,B)}}const M=new(E.count>=65535?jm:qm)(g,1);M.version=w;const S=c.get(v);S&&t.remove(S),c.set(v,M)}function _(v){const g=c.get(v);if(g){const y=v.index;y!==null&&g.version<y.version&&p(v)}else p(v);return c.get(v)}return{get:d,update:m,getWireframeAttribute:_}}function gT(r,t,i){let s;function l(g){s=g}let c,h;function d(g){c=g.type,h=g.bytesPerElement}function m(g,y){r.drawElements(s,y,c,g*h),i.update(y,s,1)}function p(g,y,E){E!==0&&(r.drawElementsInstanced(s,y,c,g*h,E),i.update(y,s,E))}function _(g,y,E){if(E===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,y,0,c,g,0,E);let M=0;for(let S=0;S<E;S++)M+=y[S];i.update(M,s,1)}function v(g,y,E,w){if(E===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let S=0;S<g.length;S++)p(g[S]/h,y[S],w[S]);else{M.multiDrawElementsInstancedWEBGL(s,y,0,c,g,0,w,0,E);let S=0;for(let C=0;C<E;C++)S+=y[C]*w[C];i.update(S,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=_,this.renderMultiDrawInstances=v}function _T(r){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,h,d){switch(i.calls++,h){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:Ye("WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function vT(r,t,i){const s=new WeakMap,l=new Rn;function c(h,d,m){const p=h.morphTargetInfluences,_=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,v=_!==void 0?_.length:0;let g=s.get(d);if(g===void 0||g.count!==v){let dt=function(){T.dispose(),s.delete(d),d.removeEventListener("dispose",dt)};var y=dt;g!==void 0&&g.texture.dispose();const E=d.morphAttributes.position!==void 0,w=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,S=d.morphAttributes.position||[],C=d.morphAttributes.normal||[],U=d.morphAttributes.color||[];let D=0;E===!0&&(D=1),w===!0&&(D=2),M===!0&&(D=3);let B=d.attributes.position.count*D,H=1;B>t.maxTextureSize&&(H=Math.ceil(B/t.maxTextureSize),B=t.maxTextureSize);const G=new Float32Array(B*H*4*v),T=new Wm(G,B,H,v);T.type=ma,T.needsUpdate=!0;const N=D*4;for(let z=0;z<v;z++){const $=S[z],Q=C[z],nt=U[z],j=B*H*4*z;for(let O=0;O<$.count;O++){const P=O*N;E===!0&&(l.fromBufferAttribute($,O),G[j+P+0]=l.x,G[j+P+1]=l.y,G[j+P+2]=l.z,G[j+P+3]=0),w===!0&&(l.fromBufferAttribute(Q,O),G[j+P+4]=l.x,G[j+P+5]=l.y,G[j+P+6]=l.z,G[j+P+7]=0),M===!0&&(l.fromBufferAttribute(nt,O),G[j+P+8]=l.x,G[j+P+9]=l.y,G[j+P+10]=l.z,G[j+P+11]=nt.itemSize===4?l.w:1)}}g={count:v,texture:T,size:new Oe(B,H)},s.set(d,g),d.addEventListener("dispose",dt)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",h.morphTexture,i);else{let E=0;for(let M=0;M<p.length;M++)E+=p[M];const w=d.morphTargetsRelative?1:1-E;m.getUniforms().setValue(r,"morphTargetBaseInfluence",w),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",g.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",g.size)}return{update:c}}function xT(r,t,i,s,l){let c=new WeakMap;function h(p){const _=l.render.frame,v=p.geometry,g=t.get(p,v);if(c.get(g)!==_&&(t.update(g),c.set(g,_)),p.isInstancedMesh&&(p.hasEventListener("dispose",m)===!1&&p.addEventListener("dispose",m),c.get(p)!==_&&(i.update(p.instanceMatrix,r.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,r.ARRAY_BUFFER),c.set(p,_))),p.isSkinnedMesh){const y=p.skeleton;c.get(y)!==_&&(y.update(),c.set(y,_))}return g}function d(){c=new WeakMap}function m(p){const _=p.target;_.removeEventListener("dispose",m),s.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:h,dispose:d}}const ST={[Nm]:"LINEAR_TONE_MAPPING",[Um]:"REINHARD_TONE_MAPPING",[Lm]:"CINEON_TONE_MAPPING",[hh]:"ACES_FILMIC_TONE_MAPPING",[Im]:"AGX_TONE_MAPPING",[Pm]:"NEUTRAL_TONE_MAPPING",[Om]:"CUSTOM_TONE_MAPPING"};function yT(r,t,i,s,l){const c=new La(t,i,{type:r,depthBuffer:s,stencilBuffer:l}),h=new La(t,i,{type:Qa,depthBuffer:!1,stencilBuffer:!1}),d=new Ji;d.setAttribute("position",new ii([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new ii([0,2,0,0,2,0],2));const m=new TS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new We(d,m),_=new Ch(-1,1,1,-1,0,1);let v=null,g=null,y=!1,E,w=null,M=[],S=!1;this.setSize=function(C,U){c.setSize(C,U),h.setSize(C,U);for(let D=0;D<M.length;D++){const B=M[D];B.setSize&&B.setSize(C,U)}},this.setEffects=function(C){M=C,S=M.length>0&&M[0].isRenderPass===!0;const U=c.width,D=c.height;for(let B=0;B<M.length;B++){const H=M[B];H.setSize&&H.setSize(U,D)}},this.begin=function(C,U){if(y||C.toneMapping===Ua&&M.length===0)return!1;if(w=U,U!==null){const D=U.width,B=U.height;(c.width!==D||c.height!==B)&&this.setSize(D,B)}return S===!1&&C.setRenderTarget(c),E=C.toneMapping,C.toneMapping=Ua,!0},this.hasRenderPass=function(){return S},this.end=function(C,U){C.toneMapping=E,y=!0;let D=c,B=h;for(let H=0;H<M.length;H++){const G=M[H];if(G.enabled!==!1&&(G.render(C,B,D,U),G.needsSwap!==!1)){const T=D;D=B,B=T}}if(v!==C.outputColorSpace||g!==C.toneMapping){v=C.outputColorSpace,g=C.toneMapping,m.defines={},qe.getTransfer(v)===en&&(m.defines.SRGB_TRANSFER="");const H=ST[g];H&&(m.defines[H]=""),m.needsUpdate=!0}m.uniforms.tDiffuse.value=D.texture,C.setRenderTarget(w),C.render(p,_),w=null,y=!1},this.isCompositing=function(){return y},this.dispose=function(){c.dispose(),h.dispose(),d.dispose(),m.dispose()}}const PS=new ui,Rm=new dl(1,1),FS=new Wm,BS=new _S,zS=new Qm,ux=[],fx=[],hx=new Float32Array(16),dx=new Float32Array(9),px=new Float32Array(4);function vl(r,t,i){const s=r[0];if(s<=0||s>0)return r;const l=t*i;let c=ux[l];if(c===void 0&&(c=new Float32Array(l),ux[l]=c),t!==0){s.toArray(c,0);for(let h=1,d=0;h!==t;++h)d+=i,r[h].toArray(c,d)}return c}function Zn(r,t){if(r.length!==t.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==t[i])return!1;return!0}function Kn(r,t){for(let i=0,s=t.length;i<s;i++)r[i]=t[i]}function Dh(r,t){let i=fx[t];i===void 0&&(i=new Int32Array(t),fx[t]=i);for(let s=0;s!==t;++s)i[s]=r.allocateTextureUnit();return i}function MT(r,t){const i=this.cache;i[0]!==t&&(r.uniform1f(this.addr,t),i[0]=t)}function ET(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(Zn(i,t))return;r.uniform2fv(this.addr,t),Kn(i,t)}}function bT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(Zn(i,t))return;r.uniform3fv(this.addr,t),Kn(i,t)}}function TT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(Zn(i,t))return;r.uniform4fv(this.addr,t),Kn(i,t)}}function AT(r,t){const i=this.cache,s=t.elements;if(s===void 0){if(Zn(i,t))return;r.uniformMatrix2fv(this.addr,!1,t),Kn(i,t)}else{if(Zn(i,s))return;px.set(s),r.uniformMatrix2fv(this.addr,!1,px),Kn(i,s)}}function RT(r,t){const i=this.cache,s=t.elements;if(s===void 0){if(Zn(i,t))return;r.uniformMatrix3fv(this.addr,!1,t),Kn(i,t)}else{if(Zn(i,s))return;dx.set(s),r.uniformMatrix3fv(this.addr,!1,dx),Kn(i,s)}}function CT(r,t){const i=this.cache,s=t.elements;if(s===void 0){if(Zn(i,t))return;r.uniformMatrix4fv(this.addr,!1,t),Kn(i,t)}else{if(Zn(i,s))return;hx.set(s),r.uniformMatrix4fv(this.addr,!1,hx),Kn(i,s)}}function wT(r,t){const i=this.cache;i[0]!==t&&(r.uniform1i(this.addr,t),i[0]=t)}function DT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(Zn(i,t))return;r.uniform2iv(this.addr,t),Kn(i,t)}}function NT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(Zn(i,t))return;r.uniform3iv(this.addr,t),Kn(i,t)}}function UT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(Zn(i,t))return;r.uniform4iv(this.addr,t),Kn(i,t)}}function LT(r,t){const i=this.cache;i[0]!==t&&(r.uniform1ui(this.addr,t),i[0]=t)}function OT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(Zn(i,t))return;r.uniform2uiv(this.addr,t),Kn(i,t)}}function IT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(Zn(i,t))return;r.uniform3uiv(this.addr,t),Kn(i,t)}}function PT(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(Zn(i,t))return;r.uniform4uiv(this.addr,t),Kn(i,t)}}function FT(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(Rm.compareFunction=i.isReversedDepthBuffer()?Mh:yh,c=Rm):c=PS,i.setTexture2D(t||c,l)}function BT(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(t||BS,l)}function zT(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(t||zS,l)}function HT(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(t||FS,l)}function GT(r){switch(r){case 5126:return MT;case 35664:return ET;case 35665:return bT;case 35666:return TT;case 35674:return AT;case 35675:return RT;case 35676:return CT;case 5124:case 35670:return wT;case 35667:case 35671:return DT;case 35668:case 35672:return NT;case 35669:case 35673:return UT;case 5125:return LT;case 36294:return OT;case 36295:return IT;case 36296:return PT;case 35678:case 36198:case 36298:case 36306:case 35682:return FT;case 35679:case 36299:case 36307:return BT;case 35680:case 36300:case 36308:case 36293:return zT;case 36289:case 36303:case 36311:case 36292:return HT}}function VT(r,t){r.uniform1fv(this.addr,t)}function kT(r,t){const i=vl(t,this.size,2);r.uniform2fv(this.addr,i)}function XT(r,t){const i=vl(t,this.size,3);r.uniform3fv(this.addr,i)}function WT(r,t){const i=vl(t,this.size,4);r.uniform4fv(this.addr,i)}function YT(r,t){const i=vl(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function qT(r,t){const i=vl(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function jT(r,t){const i=vl(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function ZT(r,t){r.uniform1iv(this.addr,t)}function KT(r,t){r.uniform2iv(this.addr,t)}function QT(r,t){r.uniform3iv(this.addr,t)}function JT(r,t){r.uniform4iv(this.addr,t)}function $T(r,t){r.uniform1uiv(this.addr,t)}function tA(r,t){r.uniform2uiv(this.addr,t)}function eA(r,t){r.uniform3uiv(this.addr,t)}function nA(r,t){r.uniform4uiv(this.addr,t)}function iA(r,t,i){const s=this.cache,l=t.length,c=Dh(i,l);Zn(s,c)||(r.uniform1iv(this.addr,c),Kn(s,c));let h;this.type===r.SAMPLER_2D_SHADOW?h=Rm:h=PS;for(let d=0;d!==l;++d)i.setTexture2D(t[d]||h,c[d])}function aA(r,t,i){const s=this.cache,l=t.length,c=Dh(i,l);Zn(s,c)||(r.uniform1iv(this.addr,c),Kn(s,c));for(let h=0;h!==l;++h)i.setTexture3D(t[h]||BS,c[h])}function sA(r,t,i){const s=this.cache,l=t.length,c=Dh(i,l);Zn(s,c)||(r.uniform1iv(this.addr,c),Kn(s,c));for(let h=0;h!==l;++h)i.setTextureCube(t[h]||zS,c[h])}function rA(r,t,i){const s=this.cache,l=t.length,c=Dh(i,l);Zn(s,c)||(r.uniform1iv(this.addr,c),Kn(s,c));for(let h=0;h!==l;++h)i.setTexture2DArray(t[h]||FS,c[h])}function oA(r){switch(r){case 5126:return VT;case 35664:return kT;case 35665:return XT;case 35666:return WT;case 35674:return YT;case 35675:return qT;case 35676:return jT;case 5124:case 35670:return ZT;case 35667:case 35671:return KT;case 35668:case 35672:return QT;case 35669:case 35673:return JT;case 5125:return $T;case 36294:return tA;case 36295:return eA;case 36296:return nA;case 35678:case 36198:case 36298:case 36306:case 35682:return iA;case 35679:case 36299:case 36307:return aA;case 35680:case 36300:case 36308:case 36293:return sA;case 36289:case 36303:case 36311:case 36292:return rA}}class lA{constructor(t,i,s){this.id=t,this.addr=s,this.cache=[],this.type=i.type,this.setValue=GT(i.type)}}class cA{constructor(t,i,s){this.id=t,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=oA(i.type)}}class uA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,s){const l=this.seq;for(let c=0,h=l.length;c!==h;++c){const d=l[c];d.setValue(t,i[d.id],s)}}}const lm=/(\w+)(\])?(\[|\.)?/g;function mx(r,t){r.seq.push(t),r.map[t.id]=t}function fA(r,t,i){const s=r.name,l=s.length;for(lm.lastIndex=0;;){const c=lm.exec(s),h=lm.lastIndex;let d=c[1];const m=c[2]==="]",p=c[3];if(m&&(d=d|0),p===void 0||p==="["&&h+2===l){mx(i,p===void 0?new lA(d,r,t):new cA(d,r,t));break}else{let v=i.map[d];v===void 0&&(v=new uA(d),mx(i,v)),i=v}}}class xf{constructor(t,i){this.seq=[],this.map={};const s=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let h=0;h<s;++h){const d=t.getActiveUniform(i,h),m=t.getUniformLocation(i,d.name);fA(d,m,this)}const l=[],c=[];for(const h of this.seq)h.type===t.SAMPLER_2D_SHADOW||h.type===t.SAMPLER_CUBE_SHADOW||h.type===t.SAMPLER_2D_ARRAY_SHADOW?l.push(h):c.push(h);l.length>0&&(this.seq=l.concat(c))}setValue(t,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(t,s,l)}setOptional(t,i,s){const l=i[s];l!==void 0&&this.setValue(t,s,l)}static upload(t,i,s,l){for(let c=0,h=i.length;c!==h;++c){const d=i[c],m=s[d.id];m.needsUpdate!==!1&&d.setValue(t,m.value,l)}}static seqWithValue(t,i){const s=[];for(let l=0,c=t.length;l!==c;++l){const h=t[l];h.id in i&&s.push(h)}return s}}function gx(r,t,i){const s=r.createShader(t);return r.shaderSource(s,i),r.compileShader(s),s}const hA=37297;let dA=0;function pA(r,t){const i=r.split(`
`),s=[],l=Math.max(t-6,0),c=Math.min(t+6,i.length);for(let h=l;h<c;h++){const d=h+1;s.push(`${d===t?">":" "} ${d}: ${i[h]}`)}return s.join(`
`)}const _x=new Ce;function mA(r){qe._getMatrix(_x,qe.workingColorSpace,r);const t=`mat3( ${_x.elements.map(i=>i.toFixed(4))} )`;switch(qe.getTransfer(r)){case Cc:return[t,"LinearTransferOETF"];case en:return[t,"sRGBTransferOETF"];default:return Se("WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function vx(r,t,i){const s=r.getShaderParameter(t,r.COMPILE_STATUS),c=(r.getShaderInfoLog(t)||"").trim();if(s&&c==="")return"";const h=/ERROR: 0:(\d+)/.exec(c);if(h){const d=parseInt(h[1]);return i.toUpperCase()+`

`+c+`

`+pA(r.getShaderSource(t),d)}else return c}function gA(r,t){const i=mA(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const _A={[Nm]:"Linear",[Um]:"Reinhard",[Lm]:"Cineon",[hh]:"ACESFilmic",[Im]:"AgX",[Pm]:"Neutral",[Om]:"Custom"};function vA(r,t){const i=_A[t];return i===void 0?(Se("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const rf=new K;function xA(){qe.getLuminanceCoefficients(rf);const r=rf.x.toFixed(4),t=rf.y.toFixed(4),i=rf.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function SA(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Sc).join(`
`)}function yA(r){const t=[];for(const i in r){const s=r[i];s!==!1&&t.push("#define "+i+" "+s)}return t.join(`
`)}function MA(r,t){const i={},s=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(t,l),h=c.name;let d=1;c.type===r.FLOAT_MAT2&&(d=2),c.type===r.FLOAT_MAT3&&(d=3),c.type===r.FLOAT_MAT4&&(d=4),i[h]={type:c.type,location:r.getAttribLocation(t,h),locationSize:d}}return i}function Sc(r){return r!==""}function xx(r,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Sx(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const EA=/^[ \t]*#include +<([\w\d./]+)>/gm;function Cm(r){return r.replace(EA,TA)}const bA=new Map;function TA(r,t){let i=De[t];if(i===void 0){const s=bA.get(t);if(s!==void 0)i=De[s],Se('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,s);else throw new Error("Can not resolve #include <"+t+">")}return Cm(i)}const AA=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function yx(r){return r.replace(AA,RA)}function RA(r,t,i,s){let l="";for(let c=parseInt(t);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Mx(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}const CA={[rl]:"SHADOWMAP_TYPE_PCF",[il]:"SHADOWMAP_TYPE_VSM"};function wA(r){return CA[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const DA={[mr]:"ENVMAP_TYPE_CUBE",[no]:"ENVMAP_TYPE_CUBE",[Uc]:"ENVMAP_TYPE_CUBE_UV"};function NA(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":DA[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const UA={[no]:"ENVMAP_MODE_REFRACTION"};function LA(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":UA[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const OA={[fh]:"ENVMAP_BLENDING_MULTIPLY",[nS]:"ENVMAP_BLENDING_MIX",[iS]:"ENVMAP_BLENDING_ADD"};function IA(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":OA[r.combine]||"ENVMAP_BLENDING_NONE"}function PA(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,s=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function FA(r,t,i,s){const l=r.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=wA(i),p=NA(i),_=LA(i),v=IA(i),g=PA(i),y=SA(i),E=yA(c),w=l.createProgram();let M,S,C=i.glslVersion?"#version "+i.glslVersion+`
